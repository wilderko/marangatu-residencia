...
| `documentos` | před podáním žádosti | 7–8      | Best-effort stažení *certificado de cumplimiento tributario*, *constancia de RUC* a *cédula tributaria* do `~/.local/share/marangatu/documentos/`. |
